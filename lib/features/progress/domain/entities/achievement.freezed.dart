...
abstract class $AchievementCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String title, String icon, bool earned, DateTime? earnedAt});
}
...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, title: $title, icon: $icon, earned: $earned, earnedAt: $earnedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, icon, earned, earnedAt);
