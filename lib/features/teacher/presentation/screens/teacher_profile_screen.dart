...
/// Teacher profile screen with account info, quick stats, and logout.
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: Spacing.lg),
            Text(l10n.teacherProfileName, style: AppTypography.heading2),
            ...
            Row(
              children: [
                _ProfileStat(
                  ...
                  label: l10n.teacherProfileClassesLabel,
                  value: l10n.teacherProfileClassesValue,
                  color: AppColors.primary,
                ),
                const SizedBox(width: Spacing.md),
                _ProfileStat(
                  icon: Iconsax.people,
                  label: l10n.teacherProfileLearnersLabel,
                  value: l10n.teacherProfileLearnersValue,
                  color: AppColors.secondary,
                ),
              ],
            ),
